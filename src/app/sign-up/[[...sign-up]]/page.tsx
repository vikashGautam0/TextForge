  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-900 via-[#0d1117] to-slate-900 p-6">
      <div className="relative group w-full max-w-md">
        {/* Decorative Glow */}
        <div className="absolute -inset-1 rounded-[2.5rem] bg-gradient-to-r from-emerald-600 to-teal-600 opacity-20 blur-2xl transition duration-1000 group-hover:opacity-30"></div>
